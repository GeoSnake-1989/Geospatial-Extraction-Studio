      ...
      <main className="workspace">
        <aside className="control-panel">
          ...
          <section className="panel-section">
            ...
            <p className="source-note">{workflow === 'elevation' ? 'USGS 3DEP seamless source raster and lightweight preview are stored separately' : workflow === 'naip' ? 'NAIP imagery provided by USDA Farm Service Agency · AOI GeoTIFF and source-item manifest stored separately' : targetOSM ? `Adding to ${targetOSM.label} · Existing layers are preserved` : 'OpenStreetMap via Overpass · ODbL attribution included in every archive'}</p>
          </div>
